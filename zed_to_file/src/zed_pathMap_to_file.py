...
class SavePath(object):
    ...
    def __init__(self):
        ...
        self._path_sub = rospy.Subscriber('/zed/zed_node/path_map', Path, self.sub_callback)
        self.write_to_file()
    ...
    def write_to_file(self):
        ...
        rospy.loginfo("Writing Map Path from Zed SDK.")

        rate = rospy.Rate(20)
        with open("Zed_Path.json", "w") as file:
        ...
        rospy.loginfo("Written Path to Zed_Path.json file")


if __name__ == "__main__":
    rospy.init_node('zed_pathMap', log_level=rospy.INFO)
