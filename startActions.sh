...
gnome-terminal -- bash -c "sleep 11;cd $HOME/proj_ws;source devel/setup.bash;rosrun rtabmap_to_file all_in_one.py;exec bash"

gnome-terminal -- bash -c "sleep 11;cd $HOME/proj_ws;source devel/setup.bash;rosrun zed_to_file one_for_all.py;exec bash"
